...
export class DataMapperAppExampleHostComponent {
	...
	@ViewChild('dataMapperComponent')
  	...
  	constructor(private initializationService: InitializationService) { 
		...
		docDef.isSource = true;
		docDef.initCfg.documentIdentifier = "com.mediadriver.atlas.java.test.v2.FlatPrimitiveClass";
		c.sourceDocs.push(docDef);
		docDef = new DocumentDefinition();
		docDef.isSource = true;
		docDef.initCfg.documentIdentifier = "com.mediadriver.atlas.java.test.v2.TestOrder";
		c.sourceDocs.push(docDef);
		...
		docDef = new DocumentDefinition();
		docDef.isSource = false;
		docDef.initCfg.documentIdentifier = "com.mediadriver.atlas.java.test.v2.CachedComplexClass";
		c.targetDocs.push(docDef);
		docDef = new DocumentDefinition();
		docDef.isSource = false;
		docDef.initCfg.documentIdentifier = "com.mediadriver.atlas.java.test.v2.TestAddress";
		c.targetDocs.push(docDef);
		docDef = new DocumentDefinition();
		docDef.isSource = false;
		docDef.initCfg.documentIdentifier = "com.mediadriver.atlas.java.test.v2.FlatPrimitiveClass";
